...
// 역할:
// - Robot Maid 원본 리소스에서 애니메이션 클립과 컨트롤러를 자동 생성합니다.
// - 플레이어/보스 비주얼 자산 준비를 반복 수작업 없이 처리하는 제작 도구입니다.
//
// 구조 포인트:
// - 아트 원본을 런타임 구조에 맞는 Unity 자산으로 변환하는 오프라인 빌더입니다.
...
public static class RobotMaidAnimationBuilder
{
    ...
    [MenuItem("Tools/Yongwoo/Build Robot Maid Animation Assets")]
