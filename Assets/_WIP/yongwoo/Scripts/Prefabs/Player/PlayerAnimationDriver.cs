...
// 역할:
// - 플레이어 이동/공격/피격 상태를 읽어 Visual 루트의 애니메이션 표현을 갱신합니다.
// - 입력이나 전투 규칙은 건드리지 않고 표현 상태 전환만 담당합니다.
//
// 구조 포인트:
// - SimplePlayerController, SimplePlayerCombat, PlayerInteraction의 결과를 시각 계층으로 번역합니다.
